...
### Self Check
- Do the odd numbered `p` elements share a class? yes (Initially did not, later changed.)
- Do the even numbered `div` elements have unique IDs? yes
- Does the Number 3 element have multiple classes? yes (Initially did not, later changed.)
